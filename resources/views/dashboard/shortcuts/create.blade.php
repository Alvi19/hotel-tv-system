@extends('layouts.app')
@section('title', 'Add Shortcut')

@section('content')
<div class="container-fluid px-4">
    <h3 class="mb-4 fw-semibold text-white">Add Shortcut</h3>

    <div class="card glass-card p-4">
        <form action="{{ route('dashboard.shortcuts.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label class="form-label fw-semibold text-light">Title</label>
                <input type="text" name="title" class="form-control glass-input" required placeholder="Enter shortcut name">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="target" class="form-control glass-input" placeholder="https://youtube.com or app package name">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="order_no" class="form-control glass-input" value="0" min="0">
            </div>

            <div class="form-check form-switch mb-4">
                <input type="checkbox" name="is_active" class="form-check-input" id="isActiveSwitch" checked>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-gradient px-4">
                    <i class="bi bi-save me-1"></i> Save Shortcut
                </button>
            </div>
        </form>
    </div>
